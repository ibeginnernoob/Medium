        ...
        <div className="flex flex-col px-20 py-6 lg:flex-row lg:pl-20 lg:pr-56 lg:justify-between">
            ...
            <div>
                ...
                <div className="flex flex-row items-center mt-3 lg:mt-6">
                    <div className="w-7 h-7 mr-3 text-sm flex flex-row justify-center items-center rounded-full cursor-pointer hover:opacity-80 bg-black text-white">
                        {get_DP(authorName)}
                    </div>
                    <h2 className="text-lg font font-extrabold lg:text-xl">
                        {authorName}
                    </h2>
                </div>
            </div>
