            ...
            <div className='flex flex-row items-center'>
                ...
                <div className='relative flex justify-center items-center group cursor-pointer mr-8 w-6 h-6 rounded-full hover:bg-slate-100'>
                    ...
                    <div className='absolute top-6 -right-4 hidden group-hover:block hover:opacity-75'>
                        <button className="text-xs font-semibold px-2 py-1 rounded-xl text-white bg-gray-400" onClick={()=>{
                            navigate('/saved')
                        }}>Saved</button>
                    </div>
                </div>
                ...
                <div className='mr-8 w-9 h-9 flex flex-row justify-center items-center rounded-full cursor-pointer hover:opacity-80 bg-black text-white'>{get_DP(username)}</div>
                <button className='border-blue-300 text-gray-500 font-medium text-xs rounded-md px-2 py-1 border-[2px] hover:opacity-70' onClick={()=>{
