            ...
            <div className="w-full">
                ...
                <div className='mb-10'>
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className='flex flex-row mr-6 items-center md:mr-12 sm:bottom-[30px]'>
                            <div className='cursor-pointer'>
                                <svg xmlns="http://www.w3.org/2000/svg" fill={saved===`save page` || saved ? "currentColour" : "none"} viewBox="0 0 24 24" strokeWidth={1.2} stroke="currentColor" className={`size-5 ${saved ? "hover:opacity-60" : "hover:opacity-30"}`} onClick={async (e)=>{
                                    savePost(id)
                                    e.preventDefault()
                                }}>
                                    {!saved ? 
