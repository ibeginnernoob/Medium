...
import { Button } from './pages/blog/lovableRequirements/button';
import { Bold, Italic } from 'lucide-react';
import { Textarea } from './pages/blog/lovableRequirements/textarea';
        ...
        <div className="flex flex-col items-center w-full bg-gray-100 rounded-lg">
            ...
            <div className="flex flex-row justify-between items-center w-full px-3 pt-2 pb-4">
                ...
                <div className="flex flex-row items-center gap-6">
                    ...
                    <Button
                        variant={'default'}
                        className="text-xs px-2 py-1 font-roboto h-fit text-white bg-gray-800 hover:bg-gray-800 hover:opacity-80"
                    >
                        Respond
                    </Button>
                </div>
