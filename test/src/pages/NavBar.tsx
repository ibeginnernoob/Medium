            ...
            <div className="flex flex-row items-center gap-6">
                ...
                <div>
                    <InputGroup
                        ...
                        startElement={<LuSearch className="ml-1" size={18} />}
                    >
                        <Input
                            className="h-fit py-2 w-[15rem] px-5 border border-white border-opacity-20 font-roboto text-xs font-light rounded-[10rem]"
                            placeholder="Search"
                        />
                    </InputGroup>
                </div>
